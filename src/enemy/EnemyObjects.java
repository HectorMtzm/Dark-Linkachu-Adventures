...
public abstract class EnemyObjects {
	public AePlayWave EnterBossLevel = new AePlayWave("bosslvl.wav");
	public AePlayWave hurtMonster = new AePlayWave("hurtmonster.wav");
	public AePlayWave bossDie = new AePlayWave("bossDie.wav");
	public AePlayWave monsterDie = new AePlayWave("monsterdie.wav");
